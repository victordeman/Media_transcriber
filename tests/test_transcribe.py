...
class TestTranscribe(unittest.TestCase):
    def test_transcribe_empty(self):
        # Note: This test assumes an empty or invalid audio file returns None
        self.assertIsNone(transcribe_audio("data/input/sample_en.wav", language="en", model_name="tiny"))
